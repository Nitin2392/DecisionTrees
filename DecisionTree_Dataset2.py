import pandas as pd
import os
data_2c = pd.read_csv(os.path.expanduser("~")+"\\BiomechanicalData_column_3C_weka.csv")
# print(data_2c)
...
print("Recall: %.3f" %recall_score(test_y, y_pred_5, average="macro"))
export_graphviz (dt_5, out_file='out_5_DS2.dot')
...
print("Recall: %.3f" %recall_score(test_y, y_pred_10, average="macro"))
export_graphviz (dt_10, out_file='out_10_DS2.dot')
...
print("Recall: %.3f" %recall_score(test_y, y_pred_15, average="macro"))
export_graphviz (dt_15, out_file='out_15_DS2.dot')
...
export_graphviz (dt_20, out_file='out_20_DS2.dot')
...
export_graphviz (dt_25, out_file='out25_DS2.dot')
